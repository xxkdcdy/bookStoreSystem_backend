...
public class UserController {
    ...
    @ResponseBody
    public boolean insertUser(@RequestBody User requestUser){
    ...
    @ResponseBody
    public myResult ChangePassword(@RequestParam Map<String, Object> requestMap) {
    ...
    @ResponseBody
    public Boolean selectAdmin(@RequestBody Map<String, Object> requestMap) {
